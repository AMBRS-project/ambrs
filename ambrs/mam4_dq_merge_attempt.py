...
class GasMixingRatios:
    def __init__(self,
        ...
        # fixme: convert to mixing ratios here or later?
...
Parameters:
    ...
    * nsteps: the number of steps in each simulation"""
        ...
        return Input(
            ...
            # fixme: use this version to reduce rounding errors in MAM4?
            ...
            # fixme: clean up --> gas mixing ratios are in mole ratio units here; converted to kg/kg in MAM4 input. 
...
"""
        ...
        with open(filename, 'w') as f:
            f.write(content)
#     def write_input_files(self, input, dir, prefix) -> None:
#         # fixme: change hard-coded camp config path
#         #'/Users/duncancq/Research/AMBRS/aero_unit_tests/MAM4-like/camp_config/mam4_config.json',
...
# f'''
# &camp_config
#     config_key = 'camp_config/mam4_config.json',
# /
# &camp_mech
